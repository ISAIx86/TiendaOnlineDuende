            ...
            <div class = "col-sm-8">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" id= "perfilDatostitulo">
                            <div class = "row">
                                <div class = "col-4">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body" id="perfilDatos">
                            <div class = "row">
                                <h4>Mis datos</h4>
                                <a href="c-updateDatos.php">
                                    <button type="button" class="btn btn-outline-dark">Actualizar mis datos</button>
                                </a>       
                            </div>
                            <div class = "row">
                                <ul class="list-group" >
                                    <li class="list-group-item">
                                        <h3>Usuario:</h3>
                                        <h5><?php echo $userData['out_username'] ?></h5>
                                    </li>
                                    <li class="list-group-item">
                                        <h5>E-mail:</h5>
